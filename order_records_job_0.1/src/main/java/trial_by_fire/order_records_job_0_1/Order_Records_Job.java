...
package trial_by_fire.order_records_job_0_1;
...
/**
 * Job: Order_Records_Job Purpose: To order the records of the excel file.<br>
 * Description: This job will order the records by the first column, States, and
 * save the results to a comma separated values (csv) file. <br>
 * 
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status
 */
public class Order_Records_Job implements TalendJob {
	...
	private final String jobName = "Order_Records_Job";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Order_Records_Job.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Order_Records_Job.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_TRIAL_BY_FIRE_Order_Records_Job = new byte[0];
		static byte[] commonByteArray_TRIAL_BY_FIRE_Order_Records_Job = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TRIAL_BY_FIRE_Order_Records_Job.length) {
					if (length < 1024 && commonByteArray_TRIAL_BY_FIRE_Order_Records_Job.length == 0) {
						commonByteArray_TRIAL_BY_FIRE_Order_Records_Job = new byte[1024];
					} else {
						commonByteArray_TRIAL_BY_FIRE_Order_Records_Job = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TRIAL_BY_FIRE_Order_Records_Job, 0, length);
				strReturn = new String(commonByteArray_TRIAL_BY_FIRE_Order_Records_Job, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TRIAL_BY_FIRE_Order_Records_Job) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:oFrXgY1bN7So7I1u6bg4nErMLD767GNDztgifw==");
				...
				Object source_tFileInputExcel_1 = "C:/Users/austi/Downloads/FraudCheck_TBF_Input.xlsx";
						...
						for (int i_tFileInputExcel_1 = begin_line_tFileInputExcel_1; i_tFileInputExcel_1 < end_line_tFileInputExcel_1; i_tFileInputExcel_1++) {
							...
							try {
								...
								if (temp_row_tFileInputExcel_1[columnIndex_tFileInputExcel_1].length() > 0) {
									curColNum_tFileInputExcel_1 = columnIndex_tFileInputExcel_1
											+ start_column_tFileInputExcel_1 + 1;
									curColName_tFileInputExcel_1 = "residents";

									row1.residents = ParserUtils.parseTo_Integer(ParserUtils.parseTo_Number(
...
// Start of branch "row1"
							if (row1 != null) {
								...
								arrayRowtSortRow_1_SortOut.state = row1.state;
								arrayRowtSortRow_1_SortOut.city = row1.city;
								arrayRowtSortRow_1_SortOut.street = row1.street;
								arrayRowtSortRow_1_SortOut.residents = row1.residents;
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/austi/OneDrive/Documents/state_residents_ordered.csv")).getAbsolutePath()
								.replace("\\", "/");
...
///////////////////////    			
				...
				for (int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++) {
					...
					row2.city = current_tSortRow_1_SortIn.city;
					row2.street = current_tSortRow_1_SortIn.street;
					row2.residents = current_tSortRow_1_SortIn.residents;
...
///////////////////////		
					...
					if (row2.street != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row2.street));
					...
					if (row2.residents != null) { //
						...
						strBuffer_tLogRow_1.append(String.valueOf(row2.residents));
...
///////////////////////    			
					...
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row3.street != null) {
						sb_tFileOutputDelimited_1.append(row3.street);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row3.residents != null) {
						sb_tFileOutputDelimited_1.append(row3.residents);
					}
...
///////////////////////    			
	...
	public static void main(String[] args) {
		final Order_Records_Job Order_Records_JobClass = new Order_Records_Job();

		int exitCode = Order_Records_JobClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Order_Records_Job.class.getClassLoader()
					.getResourceAsStream("trial_by_fire/order_records_job_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Order_Records_Job.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Order_Records_Job");
		}
...
/************************************************************************************************
 * 75333 characters generated by Talend Open Studio for Data Integration on the
 * November 30, 2022 9:40:35 PM CAT
 ************************************************************************************************/